...
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "ghostVK" is the name you will use in your source code to
                // import this module (e.g. `@import("ghostVK")`). The name is
                // repeated because you are allowed to be able to rename your imports, which
